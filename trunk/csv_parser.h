 ...
 * @author Slight modifications (bug fixes) by Al Williams <al.williams@awce.com>
 */
...
#define LIBCSV_PARSER_PATCH_VERSION 1

#define LIBCSV_PARSER_VERSION_NUMBER 10001
